...
execute unless score $GameTimer timer matches -1 if score $temp _ matches 1 run bossbar add uhunt:timer ""
execute unless score $GameTimer timer matches -1 if score $temp _ matches 1 run execute store result bossbar uhunt:timer max run scoreboard players get $GameTimer timer
execute unless score $GameTimer timer matches -1 if score $temp _ matches 1 run execute store result bossbar uhunt:timer value run scoreboard players get $GameTimer timer
execute unless score $GameTimer timer matches -1 if score $temp _ matches 1 run execute store result score $temp _ run data get storage uhunt:system c.DisplayTimer
execute unless score $GameTimer timer matches -1 if score $temp _ matches 1 run execute if score $temp _ matches 1 run bossbar set uhunt:timer players @a
execute unless score $GameTimer timer matches -1 if score $temp _ matches 1 run bossbar set uhunt:timer visible true
